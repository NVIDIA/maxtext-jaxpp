...
def init_initial_state(model, tx, config, is_training, key):
  ...
  """
  microbatch_size, rem = divmod(config.global_batch_size_to_load, config.num_pipeline_microbatches)
